...
/*   Updated: 2017/10/18 20:35:54 by cterrill         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int				main(int argc, char **argv)
{
	...
	else
	{
		...
		ft_putstr("1. - Teeeeny tiny map\n");
		ft_putstr("2. - Less tiny map\n");
	}
	return (0);
}
...
void			render_init(t_player *player, t_map *map, int room)
{
	...
	e.mouse.x = 0;
	e.mouse.y = 0;
	(room <= 1) ? system("afplay sfx/bgm_forest.mp3 &")
		: system("afplay sfx/bgm_spoopy.mp3 &");
